...
# from openai import APIError, APIStatusError, OpenAI, RateLimitError  # type: ignore
...
#     """OpenRouter defaults to a huge max_tokens; cap spend for free/low-credit accounts."""
...
#     """OpenRouter if OPENROUTER_API_KEY is set; otherwise Google Gemini API."""
#     or_key = os.getenv("OPENROUTER_API_KEY")
#     if or_key:
#         referer = os.getenv("OPENROUTER_HTTP_REFERER", "https://localhost")
#         title = os.getenv("OPENROUTER_APP_TITLE", "SaaS Idea Generator")
#         model = os.getenv(
#             "OPENROUTER_MODEL",
...
#     """Map provider errors to JSON so the client gets a clear status instead of opaque 500."""
